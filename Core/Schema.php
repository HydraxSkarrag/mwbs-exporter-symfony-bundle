<?php
namespace MwbsExporterBundle\Core;
...
class Schema extends ContainerAware
{
    ...
    {
        return $this->getBundle()->getPath() . DIRECTORY_SEPARATOR . $this->getOption('output', 'Entity/');
    }
    ...
    {
        $params = array_merge($this->defaultFormatterParams, array(
    ...
    public function export()
    {
        ...
        $document = $bootstrap->export($formatter, $this->getMwbFile(), $this->getOutputDir());
        
        // show the output
        return $document->getWriter()
            ->getStorage()
            ->getResult();
    }
}